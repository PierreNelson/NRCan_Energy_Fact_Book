    ...
    return (
        ...
        >
            <style>{`
                ...
                .page8-year-select:hover {
                    border-color: #007bff;
                }

                .page8-year-select:focus {
            ...
            <div className="page8-container">
                ...
                <div className="page8-year-selector">
                    <label 
                        id="year-label-8"
                        className="page8-year-label"
                        htmlFor="year-select-8"
                    >
                        {getText('year_slider_label', lang)}
                    </label>
                    <select
                        id="year-select-8"
                        className="page8-year-select"
                        value={year || maxYear}
                        onChange={(e) => setYear(parseInt(e.target.value))}
                        aria-labelledby="year-label-8"
                    >
