...
const Page107 = () => {
    ...
    const directLabel = getText('page107_legend_direct', lang);
    const indirectLabel = getText('page107_legend_indirect', lang);
    const totalLabel = getText('page107_legend_total', lang);

    const fileSlugBase = `${stripHtml(getText('page107_chart_title', lang))
        .normalize('NFD')
        .replace(/[\u0300-\u036f]/g, '')
        .toLowerCase()
        .replace(/[^a-z0-9]+/g, '-')
    ...
    const downloadChartWithTitle = async (plotEl = null) => {
        ...
        const title = `${stripHtml(getText('page107_chart_title', lang))} (2018-2024)`;
        const subtitle = stripHtml(getText('page107_chart_subtitle', lang));
    ...
    const downloadTableAsCSV = () => {
        ...
        const headers = [
            getText('page107_table_col_year', lang),
            ...
            sections: [
                {
                    children: [
                        new Paragraph({
                            children: [new TextRun({ text: stripHtml(getText('page107_chart_title', lang)), bold: true, size: 28 })]
                        }),
                        new Table({
                            ...
                            rows: [
                                ...
                                new TableRow({
                                    children: [
                                        new TableCell({
                                            children: [new Paragraph({ children: [new TextRun({ text: getText('page107_table_col_year', lang), bold: true })] })]
                                        }),
                                        new TableCell({
                                            children: [
                                                new Paragraph({
    ...
    return (
        <main
            ...
            role="main"
            aria-labelledby="page107-chart-title"
        ...
        >
            <style>{`
                ...
                .page107-legend-line-solid {
                    background: currentColor;
                }

                .page107-legend-label {
                    font-size: 18px;
                    color: var(--gc-text);
                }

                .page107-table-wrapper {
                    display: block;
                    width: 100%;
                    margin-top: 20px;
                    margin-bottom: 0;
                ...
                .page107-table-wrapper details > summary {
                    display: block;
                    width: 100%;
                    padding: 12px 15px;
                ...
                .page107-table-wrapper details > summary::-webkit-details-marker {
                    display: none;
                }

                .page107-table-wrapper details > summary::marker {
                    display: none;
                    content: '';
                }

                .page107-table-wrapper details > summary:hover {
                    background-color: #404040 !important;
                }

                .page107-table-wrapper .table-responsive {
                    display: block;
                    width: 100%;
                ...
                .page107-table-wrapper .table-responsive table {
                    width: max-content !important;
                    min-width: 100%;
                    border-collapse: collapse;
                }

                .page107-table-wrapper .table-responsive table.table {
                    font-family: var(--font-body);
                    color: var(--gc-text);
                }

                .page107-table-wrapper .table-responsive table th,
                .page107-table-wrapper .table-responsive table td {
                    white-space: nowrap;
                    padding: 8px 12px;
                    font-family: var(--font-body);
                    color: var(--gc-text);
                ...
                .page107-download-buttons button {
                    padding: 8px 16px;
                    border: 1px solid #404040;
                    border-radius: 4px;
                    background: #8C8C8C;
                ...
                .page107-download-buttons button:hover,
                .page107-table-wrapper button:hover,
                .page107-chart-frame button[type="button"]:hover,
                .page107-chart-frame button:hover {
                    background: #404040 !important;
                    background-color: #404040 !important;
                }

                @media (max-width: 768px) {
                    .page107-chart-title { font-size: 26px; }
                    .page107-chart-subtitle { font-size: 18px; }
                    .page107-legend { flex-wrap: wrap; gap: 20px; }
                    .page107-legend-label { font-size: 16px; }
                }

                @media (max-width: 480px) {
                    .page107-chart { height: 275px; }
                    .page107-legend-label { font-size: 14px; }
                }
            `}</style>

            <div className="page107-container">
                <div className="page107-chart-frame">
                    <h2 id="page107-chart-title" className="page107-chart-title">
                        {getText('page107_chart_title', lang)}
                    </h2>
                    <p className="page107-chart-subtitle">{getText('page107_chart_subtitle', lang)}</p>

                    <div className="page107-chart-block">
                        <div role="region" aria-label={getText('page107_chart_aria', lang)} tabIndex="0">
                                ...
                                <div aria-hidden="true">
                                    <Plot
                                        ...
                                        config={{
                                            ...
                                            modeBarButtonsToAdd: [
                                                {
                                                    name: getText('page107_download_chart', lang),
                                                    icon: {
                                                        width: 24,
                                                        height: 24,
                        ...
                        <div className="page107-legend" aria-hidden="true">
                            <div className="page107-legend-inner">
                                <div className="page107-legend-item">
                                    <span className="page107-legend-line page107-legend-line-dashed" style={{ color: COLORS.direct }}></span>
                                    <span className="page107-legend-label">{directLabel}</span>
                                </div>
                                <div className="page107-legend-item">
                                    <span className="page107-legend-line page107-legend-line-dashed" style={{ color: COLORS.indirect }}></span>
                                    <span className="page107-legend-label">{indirectLabel}</span>
                                </div>
                                <div className="page107-legend-item">
                                    <span className="page107-legend-line page107-legend-line-solid" style={{ color: COLORS.total }}></span>
                                    <span className="page107-legend-label">{totalLabel}</span>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className="page107-table-wrapper">
                        <details className="page107-data-table" onToggle={(e) => setIsTableOpen(e.currentTarget.open)}>
                            <summary role="button" aria-expanded={isTableOpen}>
                                <span aria-hidden="true" style={{ marginRight: '8px' }}>{isTableOpen ? '\u25BC' : '\u25B6'}</span>
                                {getText('page107_table_summary', lang)}
                                <span className="wb-inv">{getText('page107_table_toggle_sr', lang)}</span>
                            </summary>
                            ...
                            <div
                                ...
                                role="region"
                                tabIndex="0"
                                aria-label={getText('page107_table_aria', lang)}
                            >
                                <table className="table table-striped table-hover" style={{ marginTop: '15px' }}>
                                    <caption className="wb-inv">{getText('page107_table_caption', lang)}</caption>
                                    <thead>
                                        <tr>
                                            <td
                            ...
                            <div className="page107-download-buttons">
                                <button type="button" onClick={downloadTableAsCSV}>
                                    {getText('page107_download_csv', lang)}
                                </button>
                                <button type="button" onClick={downloadTableAsDocx}>
                                    {getText('page107_download_docx', lang)}
                                </button>
                            </div>
                        </details>
                    </div>
                ...
                <aside className="wb-fnote" role="note" style={{ marginTop: '20px', marginBottom: 0 }}>
                    <h2 id="fn-page107">{lang === 'en' ? 'Footnotes' : 'Notes de bas de page'}</h2>
                    <dl>
                        <dt>{lang === 'en' ? 'Footnote' : 'Note de bas de page'}</dt>
                        <dd style={{ marginBottom: 0 }}>
                            <p>{getText('page107_footnote', lang)}</p>
                        </dd>
                    </dl>
                </aside>
            </div>
