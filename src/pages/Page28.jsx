...
const Page28 = () => {
    ...
    .page28-table-wrapper button[type="button"]:hover,
    .page28-table-wrapper button:hover {
        background-color: #404040 !important;
    }

    .page28-chart-frame button[type="button"]:hover,
    .page28-chart-frame button:hover {
        background-color: #404040 !important;
    }
