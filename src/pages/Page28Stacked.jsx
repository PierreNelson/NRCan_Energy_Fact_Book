...
const Page28Stacked = () => {
    ...
    .page28h-table-wrapper button[type="button"]:hover,
    .page28h-table-wrapper button:hover {
        background-color: #404040 !important;
    }

    .page28h-chart-frame button[type="button"]:hover,
    .page28h-chart-frame button:hover {
        background-color: #404040 !important;
    }
