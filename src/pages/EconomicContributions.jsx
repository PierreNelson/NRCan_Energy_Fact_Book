...
import economicContributionsBgImage from '../assets/economic_contributions_bg.svg';
...
const EconomicContributions = () => {
    ...
    const getAccessibleDataTable = () => {
        ...
        const captionId = 'economic-contributions-table-caption';
...
<details
    ...
    const getTitleText = () => {
        return getText('economic_contributions_title', lang);
    };
    ...
    return (
        ...
        >
            <style>{`
                ...
                .economic-contributions-title::after {
                    content: '';
                    position: absolute;
                    left: 0;
                    bottom: 0.2em;
                ...
                .economic-contributions-body-text {
                    font-family: 'Noto Sans', sans-serif;
                    font-size: 20px;
                }

                .economic-contributions-bg-image {
                    position: absolute;
                    top: 0;
                    bottom: 0;
                    left: 0;
                ...
                .economic-contributions-year-selector {
                    display: flex;
                    align-items: center;
                    margin-bottom: 15px;
                    padding: 10px 0;
                ...
                .economic-contributions-year-label {
                    font-weight: bold;
                    margin-right: 15px;
                    font-size: 20px;
                    font-family: 'Noto Sans', sans-serif;
                ...
                .economic-contributions-container {
                    width: 100%;
                ...
                .economic-contributions-slider-track {
                    flex: 1;
                }

                .economic-contributions-content {
                    position: relative;
                    display: flex;
                    flex-direction: column;
                    min-height: 450px;
                ...
                .economic-contributions-stats-row {
                    position: relative;
                    z-index: 1;
                    display: flex;
                    flex-direction: row;
                ...
                .economic-contributions-stat-col {
                    flex: none;
                    width: fit-content;
                ...
                .economic-contributions-stat-col-1 { margin-left: 0; }
                .economic-contributions-stat-col-2 { margin-left: 240px; }
                .economic-contributions-stat-col-3 { margin-left: 240px; }

                .economic-contributions-stat-value {
                    font-family: 'Lato', sans-serif;
                    font-size: 36px;
                    font-weight: bold;
                    line-height: 1;
                ...
                .economic-contributions-stat-label {
                    font-family: 'Noto Sans', sans-serif;
                    font-size: 20px;
                }
                ...
                @media (max-width: 768px) {
                    ...
                    .economic-contributions-year-ticks { display: none !important; }
                    ...
                    .economic-contributions-slider-region {
                        flex-direction: column !important;
                        align-items: stretch !important;
                    }

                    .economic-contributions-slider-label {
                ...
                @media (max-width: 480px) {
                    ...
                    .economic-contributions-container h1 {
                    ...
                    .economic-contributions-data-table-wrapper {
                ...
                .economic-contributions-table-wrapper details > summary:hover {
                    background-color: #404040 !important;
                }

                .economic-contributions-table-wrapper details button[type="button"]:hover,
                .economic-contributions-table-wrapper details button:hover {
                    background-color: #404040 !important;
                }
                ...
                .economic-contributions-table-wrapper {
                    display: grid;
            ...
            <div className="economic-contributions-container">
                <header 
                    role="region"
                    aria-label={getTitleText()}
                    style={{ flexShrink: 0, padding: '15px 0px 0 0px'}}
                >
                    <h1 className="economic-contributions-title" aria-hidden="true">
                        {getText('economic_contributions_title', lang)}
                    </h1>
                ...
                <div className="economic-contributions-content">
                    <div 
                        className="economic-contributions-bg-image" 
                        aria-hidden="true" 
                        style={{ backgroundImage: `url(${economicContributionsBgImage})` }}
                    />

                    <section 
                        className="economic-contributions-stats-row"
                        role="region"
                        aria-label={getStatsSummary()}
                    >
                        <div className="economic-contributions-stat-col economic-contributions-stat-col-1" aria-hidden="true">
                            <div className="economic-contributions-stat-label" style={{ fontWeight: 'bold', color: '#333' }}>{getText('economic_contributions_supported', lang)}</div>
                            <div className="economic-contributions-stat-value" style={{ color: COLORS.jobs }}>
                                {formatJobs(currentYearData.jobs, currentYearData.jobs_thousands)}
                            </div>
                            <div className="economic-contributions-stat-label" style={{ color: '#666' }}>{getText('economic_contributions_jobs', lang)}</div>
                        </div>

                        <div className="economic-contributions-stat-col economic-contributions-stat-col-2" aria-hidden="true">
                            <div className="economic-contributions-stat-label" style={{ fontWeight: 'bold', color: '#333' }}>{getText('economic_contributions_generated', lang)}</div>
                            <div className="economic-contributions-stat-value" style={{ color: COLORS.income }}>
                                {formatBillions(currentYearData.employment_income, currentYearData.employment_income_billions)}
                            </div>
                            <div className="economic-contributions-stat-label" style={{ color: '#333' }}>{getText('economic_contributions_in_employment_income', lang)}</div>
                        </div>

                        <div className="economic-contributions-stat-col economic-contributions-stat-col-3" aria-hidden="true">
                            <div className="economic-contributions-stat-label" style={{ fontWeight: 'bold', color: '#333' }}>{getText('economic_contributions_and', lang)}</div>
                            <div className="economic-contributions-stat-value" style={{ color: COLORS.gdp }}>
                                {formatBillions(currentYearData.gdp, currentYearData.gdp_billions)}
                            </div>
                            <div style={{ fontSize: '30px', fontWeight: 'bold', color: '#666', lineHeight: '1' }}>{getText('economic_contributions_in_gdp', lang)}</div>
                            <div style={{ fontSize: '18px', color: '#333', marginTop: '5px' }}>
                                {getText('economic_contributions_in_year', lang)} <span style={{fontWeight: 'bold'}}>{year}</span>
                            </div>
                            <div style={{ fontSize: '14px', color: '#666', fontStyle: 'italic', marginTop: '5px' }}>
                                {getText('economic_contributions_contributions', lang)}
                            </div>
                        </div>
                    </section>
                </div>

                <div className="economic-contributions-data-table-wrapper" style={{ 
                    position: 'relative', 
                    zIndex: 2, 
                    marginTop: '20px',
                    marginBottom: '20px'
                }}>
                    <div className="economic-contributions-table-wrapper">
                ...
                >
                    <p className="economic-contributions-body-text" aria-hidden="true" style={{ margin: '0', color: '#555' }}>
                        <span>{getText('economic_contributions_footer_part1', lang)}</span>
                        <span style={{ fontWeight: 'bold' }}> {year} </span>
                        <span>{getText('economic_contributions_footer_part2', lang)} </span>
                        <span style={{ color: '#544B30', fontWeight: 'bold', fontSize: '20px' }}>
                            {formatBillions(investmentValue)}
                        </span>
                        <span> {getText('economic_contributions_footer_part3', lang)}</span>
                    </p>
                </footer>
            </div>
        </main>
