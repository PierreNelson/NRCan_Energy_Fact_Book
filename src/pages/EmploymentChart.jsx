...
const EmploymentChart = () => {
    ...
    const directLabel = getText('employment_chart_legend_direct', lang);
    const indirectLabel = getText('employment_chart_legend_indirect', lang);

    const scrollToFootnote = (e) => {
        e.preventDefault();
        document.getElementById('fn-asterisk-employment-chart')?.scrollIntoView({ behavior: 'smooth', block: 'center' });
    };

    const scrollToRef = (e) => {
        e.preventDefault();
        document.getElementById('fn-asterisk-rf-employment-chart')?.scrollIntoView({ behavior: 'smooth', block: 'center' });
    };
    ...
    const downloadChartWithTitle = async (plotEl = null) => {
        ...
        const title = `${stripHtml(getText('employment_chart_chart_title', lang))} (2018-2024)`;
        const subtitle = getText('employment_chart_chart_subtitle', lang);
    ...
    const downloadTableAsDocx = async () => {
        const title = stripHtml(getText('employment_chart_chart_title', lang));
    ...
    return (
        <main
            ...
            role="main"
            aria-labelledby="employment-chart-title"
        ...
        >
            <style>{`
                ...
                .employment-chart-chart-subtitle {
                ...
                .employment-chart-legend-item {
                    display: flex;
                    align-items: center;
                    gap: 10px;
                }

                .employment-chart-legend-color {
                    width: 30px;
                    height: 20px;
                    flex-shrink: 0;
                }

                .employment-chart-legend-label {
                    font-size: 18px;
                    color: var(--gc-text);
                }

                .employment-chart-table-wrapper {
                    display: block;
                    width: 100%;
                    margin-top: 20px;
                    margin-bottom: 0;
                ...
                .employment-chart-table-wrapper details > summary {
                    display: block;
                    width: 100%;
                    padding: 12px 15px;
                ...
                .employment-chart-table-wrapper details > summary::-webkit-details-marker {
                    display: none;
                }

                .employment-chart-table-wrapper details > summary:hover {
                    background-color: #404040 !important;
                }

                .employment-chart-table-wrapper button[type="button"]:hover,
                .employment-chart-table-wrapper button:hover,
                .employment-chart-chart-frame button[type="button"]:hover,
                .employment-chart-chart-frame button:hover {
                    background-color: #404040 !important;
                }

                /* Table horizontal scroll */
                .employment-chart-table-wrapper .table-responsive {
                    display: block;
                    width: 100%;
                ...
                .employment-chart-table-wrapper .table-responsive table {
                    width: max-content !important;
                    min-width: 100%;
                    border-collapse: collapse;
                }

                .employment-chart-table-wrapper .table-responsive table th,
                .employment-chart-table-wrapper .table-responsive table td {
                    white-space: nowrap;
                    padding: 8px 12px;
                }  

                @media (max-width: 1097px) {
                    .employment-chart-chart-subtitle { margin-left: 50px; }
                }

                @media (max-width: 960px) {
                    .employment-chart-chart-subtitle { margin-left: 10px; }
                }

                @media (max-width: 768px) {
                    .page-10 { border-right: none !important; }
                    .employment-chart-chart-title { font-size: 26px; }
                    .employment-chart-chart-subtitle { font-size: 18px; }
                    .employment-chart-legend { flex-wrap: wrap; gap: 20px; }
                    .employment-chart-legend-label { font-size: 16px; }
                    .employment-chart-chart { height: 350px; }
                }

                @media (max-width: 640px) {
                    .employment-chart-chart { height: 325px; }
                }

                @media (max-width: 480px) {
                    .employment-chart-chart { height: 275px; }
                    .employment-chart-legend-label { font-size: 14px; }
                }

                @media (max-width: 384px) {
                    .employment-chart-chart { height: 250px; }
                    .employment-chart-legend-inner {
                        flex-direction: column;       
            ...
            <div className="employment-chart-container">
                <div className="employment-chart-chart-frame">
                    <h2 className="employment-chart-chart-title" aria-hidden="true">
                        {getText('employment_chart_chart_title', lang)}
                        <sup id="fn-asterisk-rf-employment-chart" style={{ verticalAlign: 'super', fontSize: '0.6em', lineHeight: 0 }}>
                            <a className="fn-lnk" href="#fn-asterisk-employment-chart" onClick={scrollToFootnote}>
                                <span className="wb-inv">{lang === 'en' ? 'Footnote ' : 'Note de bas de page '}</span>*
                            </a>
                        </sup>
                    </h2>
                    <p className="employment-chart-chart-subtitle" aria-hidden="true">
                        {getText('employment_chart_chart_subtitle', lang)}
                    </p>
                        ...
                        {selectedPoints !== null && (
                            ...
                            <div aria-hidden="true">
                                <Plot
                                    ...
                                    className="employment-chart-chart"
                    ...
                    <div className="employment-chart-legend" aria-hidden="true">
                        <div className="employment-chart-legend-inner">
                            <div className="employment-chart-legend-item">
                                <span className="employment-chart-legend-color" style={{ backgroundColor: COLORS.direct }}></span>
                                <span className="employment-chart-legend-label">{directLabel}</span>
                            </div>
                            <div className="employment-chart-legend-item">
                                <span className="employment-chart-legend-color" style={{ backgroundColor: COLORS.indirect }}></span>
                                <span className="employment-chart-legend-label">{indirectLabel}</span>
                            </div>
                        </div>
                    </div>

                    <div className="employment-chart-table-wrapper">
                        <details 
                            className="employment-chart-data-table"
                ...
                <aside className="wb-fnote" role="note" style={{ marginTop: '20px', marginBottom: 0 }}>
                    <h2 id="fn-employment-chart">{lang === 'en' ? 'Footnotes' : 'Notes de bas de page'}</h2>
                    <dl>
                        <dt>{lang === 'en' ? 'Footnote *' : 'Note de bas de page *'}</dt>
                        <dd id="fn-asterisk-employment-chart" style={{ marginBottom: 0 }}>
                            <a href="#fn-asterisk-rf-employment-chart" onClick={scrollToRef} className="fn-num" title={lang === 'en' ? 'Return to footnote * referrer' : 'Retour à la référence de la note de bas de page *'}>
                                <span className="wb-inv">{lang === 'en' ? 'Return to footnote ' : 'Retour à la note de bas de page '}</span>*
                            </a>
                            <p>
                                {getText('employment_chart_footnote', lang)}
                            </p>
                        </dd>
                    </dl>
                </aside>
