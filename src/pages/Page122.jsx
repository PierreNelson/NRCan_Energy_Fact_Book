...
const PAGE122_DEFAULT_YEAR = YEAR_KEYS[YEAR_KEYS.length - 1];
...
const Page122 = () => {
    ...
    const [year, setYear] = useState(PAGE122_DEFAULT_YEAR);
    ...
    const productionRows = useMemo(
        () =>
            production.items.map((row, index) => ({
                ...row,
                rank: index + 1,
                name: getText(`page122_country_${row.key}`, lang),
    ...
    const downloadProductionCSV = () => {
        ...
        const tCol = getText('page122_table_col_total', lang);
        const headers = [
            yCol,
            tCol,
            ...PRODUCTION_COLUMN_KEYS.map((k) => `${stripHtml(getText(`page122_country_${k}`, lang))} (%)`)
        ];
    ...
    const downloadProductionDocx = async () => {
        const title = stripHtml(getText('page122_production_label', lang));
        const yCol = getText('page108_table_col_year', lang);
        const tCol = getText('page122_table_col_total', lang);
        const countryHeaders = PRODUCTION_COLUMN_KEYS.map(
            (k) => `${stripHtml(getText(`page122_country_${k}`, lang))} (%)`
        );
    ...
    const downloadExportsCSV = () => {
        ...
        const headers = [
            yCol,
            tCol,
            ...EXPORT_COLUMN_KEYS.map((k) => `${stripHtml(getText(`page122_country_${k}`, lang))} (%)`)
        ];
    ...
    const downloadExportsDocx = async () => {
        const title = stripHtml(getText('page122_exports_label', lang));
        const yCol = getText('page108_table_col_year', lang);
        const tCol = getText('page122_table_col_total', lang);
    ...
    return (
        <main
            id="main-content"
            tabIndex="-1"
            className="page-content page-108 page122-natural-gas"
            role="main"
            aria-labelledby="page122-main-title"
            style={{ backgroundColor: '#ffffff' }}
        >
            <style>{`
                .page-108.page122-natural-gas {
            ...
            <div className="page108-container">
                <header>
                    <h1 id="page122-main-title" className="page108-title">
                        {getText('page122_title', lang)}
                    </h1>
                    <p className="page108-subtitle">{getText('page122_subtitle', lang)}</p>
                </header>
                ...
                <>
                    ...
                    <div className="page108-content-wrapper layout-stacked">
                        <div className="page108-chart-section">
                            <h3 className="page108-graphic-title">
                                <span aria-hidden="true">
                                    {getText('page122_production_label', lang)}
                                    {' \u2013 '}
                                    {formatVolume(production.total)} {getText('page122_unit_bcf', lang)} (
                                    {formatVolume(production.bcm)} {getText('page122_unit_bcm', lang)}) ({year})
                                </span>
                            </h3>
                            ...
                            >
                                ...
                                >
                                    <table className="table table-bordered table-striped table-hover">
                                        <caption className="wb-inv">{getText('page122_table_caption_production', lang)}</caption>
                                        <thead>
                                            <tr>
                                                <th
                                                    scope="col"
                                                ...
                                                >
                                                    {getText('page122_table_col_total', lang)}
                                                </th>
                                                {PRODUCTION_COLUMN_KEYS.map((k) => (
                                                    ...
                                                    >
                                                        {getText(`page122_country_${k}`, lang)} (%)
                                                    </th>
                                                ))}
                                            </tr>
                                        </thead>
                        ...
                        <div className="page108-chart-section">
                            <h3 className="page108-graphic-title">
                                <span aria-hidden="true">
                                    {getText('page122_exports_label', lang)}
                                    {' \u2013 '}
                                    {formatVolume(exportsBlock.total)} {getText('page122_unit_bcf', lang)} (
                                    {formatVolume(exportsBlock.bcm)} {getText('page122_unit_bcm', lang)}) ({year})
                                </span>
                            </h3>
                            ...
                            >
                                ...
                                >
                                    <table className="table table-bordered table-striped table-hover">
                                        <caption className="wb-inv">{getText('page122_table_caption_exports', lang)}</caption>
                                        <thead>
                                            <tr>
                                                <th
                                                    scope="col"
