...
const PetroleumEmployment = () => {
    ...
    const directLabel = getText('petroleum_employment_legend_direct', lang);
    const indirectLabel = getText('petroleum_employment_legend_indirect', lang);
    const totalLabel = getText('petroleum_employment_legend_total', lang);
    ...
    const fileSlugBase = `${stripHtml(getText('petroleum_employment_chart_title', lang))
        .normalize('NFD')
        .replace(/[\u0300-\u036f]/g, '')
        .toLowerCase()
        .replace(/[^a-z0-9]+/g, '-')
    ...
    const downloadChartWithTitle = async (plotEl = null) => {
        ...
        const title = `${stripHtml(getText('petroleum_employment_chart_title', lang))} (2018-2024)`;
        const subtitle = stripHtml(getText('petroleum_employment_chart_subtitle', lang));
    ...
    const downloadTableAsDocx = async () => {
        const unitText = getText('petroleum_employment_table_unit_row', lang);
        const doc = new Document({
            sections: [
                {
                    children: [
                        new Paragraph({
                            children: [new TextRun({ text: stripHtml(getText('petroleum_employment_chart_title', lang)), bold: true, size: 28 })]
                        }),
                        new Table({
                            ...
                            rows: [
                                ...
                                new TableRow({
                                    children: [
                                        new TableCell({
                                            children: [new Paragraph({ children: [new TextRun({ text: getText('petroleum_employment_table_col_year', lang), bold: true })] })]
                                        }),
                                        new TableCell({
                                            children: [
                                                new Paragraph({
    ...
    return (
        <main
            ...
            role="main"
            aria-labelledby="petroleum-employment-chart-title"
        ...
        >
            <style>{`
                ...
                .petroleum-employment-rpp-crosslink {
                    font-family: var(--font-body);
                    font-size: 1rem;
                    line-height: 1.5;
                    margin: 0 0 16px 0;
                }
                .petroleum-employment-rpp-crosslink a {
                    font-weight: 600;
                }
                .petroleum-employment-container {
                    width: 100%;
                ...
                .petroleum-employment-chart-frame {
                ...
                .petroleum-employment-chart-title {
                ...
                .petroleum-employment-chart-subtitle {
                ...
                .petroleum-employment-chart-block {
                    display: flex;
                    flex-direction: column;
                    align-items: stretch;
                    width: 100%;
                ...
                .petroleum-employment-legend-inner {
                    display: flex;
                    flex-wrap: wrap;
                    gap: 15px 40px;
                    justify-content: center;
                ...
                .petroleum-employment-legend-item {
                    display: flex;
                    align-items: center;
                    gap: 10px;
                }

                .petroleum-employment-legend-swatch {
                    width: 22px;
                    height: 14px;
                    flex-shrink: 0;
                }

                .petroleum-employment-legend-label {
                    font-size: 18px;
                    color: var(--gc-text);
                }

                .petroleum-employment-table-wrapper {
                    display: block;
                    width: 100%;
                    margin-top: 20px;
                    margin-bottom: 0;
                ...
                .petroleum-employment-table-wrapper details > summary {
                    display: block;
                    width: 100%;
                    padding: 12px 15px;
                ...
                .petroleum-employment-table-wrapper details > summary::-webkit-details-marker {
                    display: none;
                }

                .petroleum-employment-table-wrapper details > summary::marker {
                    display: none;
                    content: '';
                }

                .petroleum-employment-table-wrapper details > summary:hover {
                    background-color: #404040 !important;
                }

                .petroleum-employment-table-wrapper .table-responsive {
                    display: block;
                    width: 100%;
                ...
                .petroleum-employment-table-wrapper .table-responsive table {
                    width: max-content !important;
                    min-width: 100%;
                    border-collapse: collapse;
                }

                .petroleum-employment-table-wrapper .table-responsive table.table {
                    font-family: var(--font-body);
                    color: var(--gc-text);
                }

                .petroleum-employment-table-wrapper .table-responsive table th,
                .petroleum-employment-table-wrapper .table-responsive table td {
                    white-space: nowrap;
                    padding: 8px 12px;
                    font-family: var(--font-body);
                    color: var(--gc-text);
                ...
                .petroleum-employment-download-buttons {
                    display: flex;
                    gap: 10px;
                    margin-top: 15px;
                    flex-wrap: wrap;
                ...
                .petroleum-employment-download-buttons button {
                    padding: 8px 16px;
                    border: 1px solid #404040;
                    border-radius: 4px;
                    background: #8C8C8C;
                ...
                .petroleum-employment-download-buttons button:hover,
                .petroleum-employment-table-wrapper button:hover,
                .petroleum-employment-chart-frame button[type="button"]:hover,
                .petroleum-employment-chart-frame button:hover {
                    background: #404040 !important;
                    background-color: #404040 !important;
                }

                @media (max-width: 768px) {
                    .petroleum-employment-chart-title { font-size: 26px; }
                    .petroleum-employment-chart-subtitle { font-size: 18px; }
                    .petroleum-employment-legend { flex-wrap: wrap; gap: 20px; }
                    .petroleum-employment-legend-label { font-size: 16px; }
                }

                @media (max-width: 480px) {
                    .petroleum-employment-legend-label { font-size: 14px; }
                }
            `}</style>

            <div className="petroleum-employment-container">
                <div className="petroleum-employment-chart-frame">
                    <h2 id="petroleum-employment-chart-title" className="petroleum-employment-chart-title">
                        {getText('petroleum_employment_chart_title', lang)}
                    </h2>
                    <p className="petroleum-employment-chart-subtitle">{getText('petroleum_employment_chart_subtitle', lang)}</p>

                    <div className="petroleum-employment-chart-block">
                        <div role="region" aria-label={getText('petroleum_employment_chart_aria', lang)} tabIndex="0">
                            {selectedPoints !== null && (
                                ...
                                <div aria-hidden="true">
                                    <Plot
                                        ...
                                        config={{
                                            ...
                                            modeBarButtonsToAdd: [
                                                {
                                                    name: getText('petroleum_employment_download_chart', lang),
                                                    icon: {
                                                        width: 24,
                                                        height: 24,
                                        ...
                                        className="petroleum-employment-chart"
                        ...
                        <div className="petroleum-employment-legend" aria-hidden="true">
                            <div className="petroleum-employment-legend-inner">
                                <div className="petroleum-employment-legend-item">
                                    <span className="petroleum-employment-legend-swatch" style={{ backgroundColor: COLORS.direct }}></span>
                                    <span className="petroleum-employment-legend-label">{directLabel}</span>
                                </div>
                                <div className="petroleum-employment-legend-item">
                                    <span className="petroleum-employment-legend-swatch" style={{ backgroundColor: COLORS.indirect }}></span>
                                    <span className="petroleum-employment-legend-label">{indirectLabel}</span>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className="petroleum-employment-table-wrapper">
                        <details className="petroleum-employment-data-table" onToggle={(e) => setIsTableOpen(e.currentTarget.open)}>
                            <summary role="button" aria-expanded={isTableOpen}>
                                <span aria-hidden="true" style={{ marginRight: '8px' }}>{isTableOpen ? '▼' : '▶'}</span>
                                {getText('petroleum_employment_table_summary', lang)}
                                <span className="wb-inv">{getText('petroleum_employment_table_toggle_sr', lang)}</span>
                            </summary>
                            ...
                            <div
                                ...
                                role="region"
                                tabIndex="0"
                                aria-label={getText('petroleum_employment_table_aria', lang)}
                            >
                                <table className="table table-striped table-hover" style={{ marginTop: '15px' }}>
                                    <caption className="wb-inv">{getText('petroleum_employment_table_caption', lang)}</caption>
                                    <thead>
                                        <tr>
                                            <td
                                            ...
                                            >
                                                <span aria-hidden="true">{getText('petroleum_employment_table_unit_row', lang)}</span>
                                                <span className="wb-inv">{getText('petroleum_employment_table_unit_row', lang)}</span>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th
                            ...
                            <div className="petroleum-employment-download-buttons">
                                <button type="button" onClick={downloadTableAsCSV}>
                                    {getText('petroleum_employment_download_csv', lang)}
                                </button>
                                <button type="button" onClick={downloadTableAsDocx}>
                                    {getText('petroleum_employment_download_docx', lang)}
                                </button>
                            </div>
                        </details>
                    </div>
                ...
                <aside className="wb-fnote" role="note" style={{ marginTop: '20px', marginBottom: 0 }}>
                    <h2 id="fn-petroleum-employment">{lang === 'en' ? 'Footnotes' : 'Notes de bas de page'}</h2>
                    <dl>
                        <dt>{lang === 'en' ? 'Footnote' : 'Note de bas de page'}</dt>
                        <dd style={{ marginBottom: 0 }}>
                            <p>{getText('petroleum_employment_footnote', lang)}</p>
                        </dd>
                    </dl>
                </aside>
            </div>
...
export default PetroleumEmployment;
