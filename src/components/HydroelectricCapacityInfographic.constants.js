/**
 * Hydroelectric infographic chart backdrop — tune overlay positions and dam image (major_hydro_facilities_bg_1.png) here.
 * Asset filenames on disk: bg_1 = dam graphic, bg_2 = Canada map.
 */
import majorHydroFacilitiesBgDam from '../assets/major_hydro_facilities_bg_1.png';
import majorHydroFacilitiesBgMap from '../assets/major_hydro_facilities_bg_2.png';

export { majorHydroFacilitiesBgDam, majorHydroFacilitiesBgMap };
...
/**
 * Dam graphic (major_hydro_facilities_bg_1.png) — position as % of chart backdrop box.
