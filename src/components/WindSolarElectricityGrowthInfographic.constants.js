/** wind/solar growth overlay on wind_solar_electricity_growth_bg.png (436×280 native). */
import windSolarElectricityGrowthBg from '../assets/wind_solar_electricity_growth_bg.png';

export { windSolarElectricityGrowthBg };
...
export const exportWindSolarGrowthInfographicPng = async (figureEl, { title, scale = 2 }) => {
    ...
    const wrapper = figureEl.querySelector?.('.wind-solar-electricity-growth-infographic-wrapper') ?? figureEl;
    ...
    const bgImg = wrapper.querySelector('.wind-solar-electricity-growth-bg-image');
    const overlayEls = [...wrapper.querySelectorAll('.wind-solar-electricity-growth-overlay')];
