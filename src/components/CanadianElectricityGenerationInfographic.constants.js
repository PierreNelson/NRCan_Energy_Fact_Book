/** Must match actual electricity_generation_canada_bg.png / electricity_generation_canada_bg_fr.png pixel dimensions (aspect ~763:560, same as provincial generation infographic). */
...
export const exportCanadianGenerationInfographicPng = async (figureEl, { scale = 2 }) => {
    ...
    const wrapper = figureEl.querySelector('.canadian-electricity-generation-infographic-wrapper');
    ...
    const bgImg = wrapper.querySelector('.canadian-electricity-generation-bg-image');
    ...
    wrapper.querySelectorAll('.canadian-electricity-generation-overlay').forEach(drawTextEl);
