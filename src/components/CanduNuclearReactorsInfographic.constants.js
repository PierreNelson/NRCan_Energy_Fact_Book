/**
 * Overlay anchors (% of wrapper) calibrated to candu_nuclear_reactors_bg.png (902×224).
 * Adjust left / top / width to reposition the abroad-reactors callout.
 */
import canduNuclearReactorsBg from '../assets/candu_nuclear_reactors_bg.png';

export { canduNuclearReactorsBg };
