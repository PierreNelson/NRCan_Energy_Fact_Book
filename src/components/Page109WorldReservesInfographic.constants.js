/**
 * Overlay anchors (% of wrapper) calibrated to page109_bg.svg (690.44 × 480.81).
 *
 * Fine-tuning guide:
...
export const COUNTRY_LABEL_KEYS = {
    other: 'page109_country_other',
    venezuela: 'page109_country_venezuela',
    saudi: 'page109_country_saudi',
    iran: 'page109_country_iran',
    canada: 'page109_country_canada',
    iraq: 'page109_country_iraq',
};
