...
LEGACY_PAGE_ORDER: list[int] = [
    ...
    59, 60, 61, 62, 63, 64, 65, 66, 67, 68, 69, 70, 71, 74, 76, 78, 79, 80, 81, 82, 84, 85, 86, 87, 89, 90, 91, 93, 95, 96, 97, 98, 99, 102,
    103, 105, 106, 107, 108, 109, 110, 111, 112, 113, 117, 119, 122, 123, 126, 132, 135, 136, 138, 139, 140,
]
...
def validate_registry(entries: list[PageRegistryEntry]) -> list[str]:
    errors: list[str] = []
    if len(entries) != 105:
        errors.append(f"expected 105 entries, got {len(entries)}")
