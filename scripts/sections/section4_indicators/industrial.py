...
from .constants import OEE_INDUSTRIAL_CP_URL, REQUEST_TIMEOUT
...
def _ee_improvement_path(processor):
    ...
    return processor._resolve_path(path_str, base_dir) if path_str else base_dir / 'EE Improvement.xlsx'
